        ...
        <v-row no-gutters>
            <v-col sm-10 class="mx-auto">
                <v-card class="pa-5">
                    ...
                    <v-form ref="form" @submit.prevent="editForm" class="pa-5" enctype="multipart/form-data">
                        ...
                        <v-img height="120" width="150" :src="`/${post.image}`">
                        </v-img>
                        <v-btn type="submit" class="mt-3" color="info">Update Post</v-btn>
